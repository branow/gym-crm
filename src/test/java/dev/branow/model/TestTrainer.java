...
public class TestTrainer extends DBTest {
    ...
    public void testPersist_withoutSpecialization_throwsException() {
        ...
        assertThrows(ConstraintViolationException.class, () -> manager.persist(trainer));
    }
    ...
    public void testPersist_withoutTrainings_persistTrainer() {
        ...
        var expectedTrainerCount = manager.count(Trainer.class) + 1;
        ...
        var actualTrainerCount = manager.count(Trainer.class);
